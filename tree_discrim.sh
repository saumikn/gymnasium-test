...
"cd ~/gymnasium-test && /storage1/fs1/chien-ju.ho/Active/.conda/envs/random/bin/python tree_discrim.py single" ${SEED}-${SEED100} ${DEPTH} ${MODE}-${FREQ} ${BUDGET_TYPE}_${BUDGET} ${STEPS}
